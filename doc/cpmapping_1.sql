...
CREATE TABLE `ps_item`  (
  `item_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '项目id',
...
CREATE TABLE `ps_item_element`  (
  ...
  `height` double NOT NULL COMMENT '元素高度，单位像素',
  `width` double NOT NULL COMMENT '元素宽度，单位像素',
