  ...
  <div id='updateCredential' style='text-align: left'>
      <el-dialog
        ...
        <span slot='footer' class='dialog-footer'>
            <el-button @click='updateProjectElementsPic' type='primary' size='mini' v-loading.fullscreen.lock='loadingfullscreen'>提交</el-button>
      ...
      axios.get(_this.GLOBAL.WEB_URL + '/gp/getfontlist').then(
        (response) => {
          if (response.data['errcode'] === 0) {
            ...
            _this.$router.push({path: '/login'}) // 重新登录
          }
        }
      )
    },
