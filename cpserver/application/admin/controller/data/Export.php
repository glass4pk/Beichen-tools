...
class Export extends ApiCommon
{
    ...
    public function exportToExcel()
    {
        ...
        $partnerAttentionModel = model('data.PartnerAttention');
        $userAttentionModel = model('data.UserAttention'); 
        $userPromoteSection = model('data.UserPromoteSection');
